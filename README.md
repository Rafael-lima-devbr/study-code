...
Study code in **C, C++ and Python** — exercises, programming contests and learning experiments.
...
| File | What it practices |
|---|---|
| `OBI/obi-2025-fase-1/bar_chart.cpp` | Matrix construction and graphical representation |
| `OBI/obi-2025-fase-1/cafeteria.cpp` | Interval validation and arithmetic reasoning |
| `OBI/obi-2025-fase-1/festa_junina.cpp` | Distance calculation using absolute values |
| `OBI/obi-2025-fase-1/garfield_calories.cpp` | Accumulators and calorie calculation |
...
| `pierres_warehouse.cpp` | Priority queue for priority-based service scheduling |
| `item_collection.cpp` | std::map for inventory management, accumulation and requirement validation |
...
| File | What it practices |
|---|---|
| `exercises/bank_account.py` | Object-oriented programming (classes, encapsulation, getters/setters and methods) |
| `exercises/calculator.py` | GUI development with Tkinter, event handling and modularization |
